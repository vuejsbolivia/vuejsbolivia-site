  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/logo.svg" class="w-64" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/logo_dark_mode.svg" class="w-64" alt="logo" /></g-link>
        </div>
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#proyectos" v-scroll-to="'#proyectos'" class="text-copy-primary hover:text-gray-600">Proyectos</a>
            <g-link v-else to="/#proyectos" class="text-copy-primary hover:text-gray-600">Proyectos</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#contactos" v-scroll-to="'#contactos'" class="text-copy-primary hover:text-gray-600">Contactos</a>
            <g-link v-else to="/#contactos" class="text-copy-primary hover:text-gray-600">Contactos</g-link>
          </li>
          <li>
    ...
    <footer class="bg-gray-900 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:vuejs.bolivia.community.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/vuejs-bolivia" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/vuejsbolivia" target="_blank" class="text-white hover:text-gray-400">
        ...
        <div class="mb-8 lg:mb-0">
          <div>Hecho por y para la Comunidad 💚 Vue.js Bolivia {{ year }}.</div>
