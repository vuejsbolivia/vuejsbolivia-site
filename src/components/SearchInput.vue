<template>
  <div class="relative">
    ...
    <div class="relative w-48">
      <input
        type="text"
        placeholder="Buscar (Presione &quot;/&quot; para enfocar)"
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-2 outline-none focus:border-green-500 w-48"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
