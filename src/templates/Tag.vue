<template>
  <Layout>
    <div class="container-inner mx-auto my-16">
      <h2 class="text-4xl font-bold mb-8 border-b">Etiqueta: {{ $page.tag.title }}</h2>
      ...
      <div v-for="post in $page.tag.belongsTo.edges" :key="post.node.id" class="post border-gray-400 border-b mb-12">
        ...
        <div class="text-copy-secondary mb-4">
          ...
          <span> &middot; </span>
          <span>{{ post.node.timeToRead }} min de lectura</span>
        </div>
        ...
        <div class="mb-8">
          <g-link :to="post.node.path" class="font-bold uppercase">Leer más</g-link>
        </div>
      </div>
